...
type FakeFoos struct {
	Fake *FakeExmapleV1alpha1
	ns   string
}

var foosResource = schema.GroupVersionResource{Group: "exmaple.com", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "exmaple.com", Version: "v1alpha1", Kind: "Foo"}
